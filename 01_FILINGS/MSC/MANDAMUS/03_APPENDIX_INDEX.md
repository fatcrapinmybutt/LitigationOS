...
## APPENDIX TO APPLICATION FOR WRIT OF MANDAMUS
### Required Pursuant to MCR 7.306(C)(3)
...
### TAB A — LOWER COURT ORDERS CHALLENGED
...
### TAB B — DISQUALIFICATION MOTION AND RELATED FILINGS
...
### TAB C — EVIDENCE OF EX PARTE PROCEEDINGS
...
### TAB D — PARENTING TIME ENFORCEMENT HISTORY
...
### TAB E — DUE PROCESS / CONTEMPT PROCEEDINGS
...
### TAB F — STATISTICAL ANALYSIS AND EXPERT EXHIBITS

| Tab | Document | Date | Description |
|-----|----------|------|-------------|
| F-1 | Parental Alienation Analysis | — | Three-framework analysis documenting 305 interference incidents across the Watson family |
| F-2 | Baker 17 Strategies Assessment | — | Assessment showing Watson matches 15 of 17 Baker alienation strategies (88.2%) |
| F-3 | Childress Attachment-Based Model Assessment | — | All three diagnostic indicators present |
| F-4 | Warshak Five-Factor Model Assessment | — | All five factors satisfied |
| F-5 | Ex Parte Communication Rate Calculation | — | Methodology and data supporting 44% (24 of 55 orders) figure |
| F-6 | Best Interest Factor Analysis | — | Factor-by-factor analysis under MCL 722.23 showing 12/12 factors favor Petitioner |
| F-7 | Case Timeline | — | Comprehensive chronological timeline of proceedings and events |

---

### TAB G — COURT OF APPEALS MATERIALS
...
### TAB H — CONSTITUTIONAL AND STATUTORY AUTHORITIES

| Tab | Document | Description |
|-----|----------|-------------|
| H-1 | MCL 552.644 | Parenting time enforcement (full text) |
| H-2 | MCL 722.23 | Best interest of child factors (full text) |
| H-3 | MCR 2.003 | Disqualification of judge (full text) |
| H-4 | MCR 7.306 | Extraordinary writs — Supreme Court (full text) |
| H-5 | MCR 3.206 | Domestic relations proceedings (relevant excerpts) |
| H-6 | Const 1963, Art 6, § 4 | Superintending control authority |
| H-7 | Canon 3(B)(7) | Michigan Code of Judicial Conduct — ex parte communications |

---

### TAB I — IFP APPLICATION (CROSS-REFERENCE)

| Tab | Document | Description |
|-----|----------|-------------|
| I-1 | MSC IFP Application | Filed concurrently (see `01_FILINGS\MSC\IFP\01_MSC_IFP_APPLICATION.md`) |
| I-2 | Affidavit of Inability to Pay | SCAO MC 20 format (see `01_FILINGS\MSC\IFP\02_AFFIDAVIT_INABILITY_TO_PAY.md`) |
| I-3 | Brief in Support of IFP Application | (see `01_FILINGS\MSC\IFP\03_BRIEF_IN_SUPPORT_IFP.md`) |
| I-4 | Proposed Order Granting IFP | (see `01_FILINGS\MSC\IFP\04_PROPOSED_ORDER_IFP.md`) |

---

## APPENDIX CERTIFICATION

I, Andrew J. Pigors, certify that the documents contained in this Appendix are true and correct copies of the originals in my possession or from the court record, to the best of my knowledge, information, and belief.
...
## ASSEMBLY INSTRUCTIONS FOR PETITIONER
...
>
> 3. **Print and tab each exhibit** using the Tab designations above (A through I).
>
> 4. **Number all appendix pages** consecutively (Appx-001, Appx-002, etc.) in the bottom right corner.
>
> 5. **Create a physical table of contents** matching this index for the front of the appendix binder.
>
> 6. **Statistical exhibits** (Tab F) can be generated from the evidence archive — they are already documented and formatted in the system.
>
> 7. **The IFP application** (Tab I) should be filed as a separate document but cross-referenced here. It is already prepared at `01_FILINGS\MSC\IFP\`.
