...
- `staging/!LEGAL_ANALYSIS_OUTPUT/LEGAL_ANALYSIS_OUTPUT/03_DECISION_TREES/2026-02-10_FILING_INSTRUCTIONS_COMPLETE.md:L1237` — I, [YOUR NAME], certify that I have made reasonable efforts to resolve the discovery dispute with [OPPOSING PARTY] before filing this motion, as required by MCR 2.401(I).
...
- `staging/LEGAL_OUTPUT/LEGAL_OUTPUT/03_DECISION_TREES/2026-02-10_FILING_INSTRUCTIONS_COMPLETE.md:L1237` — I, [YOUR NAME], certify that I have made reasonable efforts to resolve the discovery dispute with [OPPOSING PARTY] before filing this motion, as required by MCR 2.401(I).
...
- `staging/!LEGAL_ANALYSIS_OUTPUT/LEGAL_ANALYSIS_OUTPUT/03_DECISION_TREES/2026-02-10_FILING_INSTRUCTIONS_COMPLETE.md:L306` — 4. NOTICE: The Clerk shall immediately provide notice of this Order to [OPPOSING PARTY] at [ADDRESS] by [certified mail/personal service].
...
- `staging/LEGAL_OUTPUT/LEGAL_OUTPUT/03_DECISION_TREES/2026-02-10_FILING_INSTRUCTIONS_COMPLETE.md:L306` — 4. NOTICE: The Clerk shall immediately provide notice of this Order to [OPPOSING PARTY] at [ADDRESS] by [certified mail/personal service].
