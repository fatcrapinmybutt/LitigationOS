...
## Ronald Berry (Non-Attorney) — AGC Complaint (UPL under MCL 600.916)

---

**Complainant:** Andrew J. Pigors
**Respondent:** Ronald Berry (non-attorney; not a licensed Michigan attorney — AGC complaint reframed as UPL under MCL 600.916)
...
## BERRY'S ENTRY AND INITIAL CONDUCT
...
## CRITICAL PERIOD — ALIENATION DEEPENS
...
## AGGREGATE STATISTICS (as of complaint date)
...
| Total evidence items compiled | 224,000+ | Case evidence archive |
| MRPC rules violated | 7 (1.1, 1.2(d), 1.3, 3.3, 3.4, 4.4, 8.4) | This complaint |
...
3. **Obtain hearing transcripts.** For events that occurred at hearings (false statements, ex parte references), you need the transcript with page and line numbers.

4. **Prioritize the strongest incidents.** The AGC investigator will focus on specific, documented acts. Ensure the most egregious incidents have the most detail.

5. **Maintain chronological order.** The power of this timeline is the cumulative pattern. Each individual act builds upon the last, demonstrating a sustained course of misconduct — not isolated incidents.
