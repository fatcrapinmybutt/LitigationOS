...
---
## FIX11 Addendum — Tasks + Plugin Runner + Local Semantic (optional)
- Create 4x/day scheduled runs: `L3\ops\MAKE_TASKS_4X_DAILY.bat`
- Remove tasks: `L3\ops\REMOVE_TASKS.bat`
- Run staged plugin runner (checkpointed): `RUN_STAGES.bat`
- Optional local semantic layer docs: `L3\sem\SEM_RUNBOOK.md`
