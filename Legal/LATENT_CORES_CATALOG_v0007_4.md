...
## v0007 Additions (Contracts + Bloom + CI)
- GraphContracts: JSON Schemas for nodes/edges CSV + validator tool.
- BloomPerspectivePack: caption mapping + import checklist.
- CI Discipline: GitHub Actions starter + pinned dependency strategy.
- Win Signing Hook: safe signtool wrapper with fail-fast.
