...
# LITIGATION-SUPREME-COMMANDER — Elite Composite Skill

> Forged from 22 individual skills into one supreme composite.
> Sources: litigation-complaint-drafter, litigation-brief-writer, litigation-motion-practice, michigan-litigation-writer, litigation-filing-architect, litigation-pro-se-guardian, litigation-service-engine, litigation-sanctions-engine, litigation-analysis-engine, litigation-convergence-orchestrator, litigation-pipeline-commander, litigation-lawsuit-forge, litigation-record-builder, litigation-os, litigation-skill-auditor, litigation-court-order-tracker, litigation-mandatory-disclosure-specialist, litigation-fee-petition-engine, litigation-default-judgment-engine, litigation-summary-judgment-engine, litigation-contempt-specialist, litigation-foc-challenge-engine

## When to Apply

Activate this skill for ANY work related to:
- **Filing & Drafting Core**: complaint drafting, brief writing, motion practice, filing architecture
- **Michigan Litigation Standards**: Michigan-specific rules, court rules, formatting, MCR citations
- **Pro Se Litigation Guide**: self-representation, procedural navigation, court etiquette, common pitfalls
- **Service & Process**: service of process rules, proof of service, alternative service, MCR 2.105
- **Sanctions & Enforcement**: sanctions motions, contempt proceedings, fee petitions, enforcement
- **Analysis & Strategy**: case analysis, convergence orchestration, pipeline command, record building
- **Judgment Engines**: default judgment, summary judgment, FOC challenges, court order tracking
- **System Integration**: LitigationOS core, skill auditing, mandatory disclosure, filing workflow

---

## §1. Filing & Drafting Core

> complaint drafting, brief writing, motion practice, filing architecture

### Argument Architecture Framework
*Source: litigation-brief-writer*
...
*Source: michigan-litigation-writer*
...
*Source: litigation-filing-architect*
...
## §2. Michigan Litigation Standards

> Michigan-specific rules, court rules, formatting, MCR citations

### Michigan Court Knowledge
*Source: litigation-analysis-engine*
...
*Source: litigation-complaint-drafter*
...
## §3. Pro Se Litigation Guide

> self-representation, procedural navigation, court etiquette, common pitfalls

### Procedural Safety Checklist
*Source: litigation-pro-se-guardian*

Before filing ANY document, run through this checklist:

```
PRE-FILING SAFETY CHECK
========================
□  1. DEADLINE:     Is this filing timely? What rule sets the deadline?
□  2. COURT:        Correct court and division? (Circuit, COA, Federal?)
□  3. CAPTION:      MCR 2.113 compliant? Case number correct?
□  4. FORMAT:       Meets local formatting rules? (See style-guide)
□  5. SIGNATURE:    Signed with name, address, phone, email? (MCR 2.114)
□  6. VERIFICATION: Does this filing require verification? (sworn statement)
□  7. CERTIFICATE:  Certificate of Service included and accurate?
□  8. SERVICE:      Served on ALL parties simultaneously with filing?
□  9. COPIES:       Correct number of copies? (Original + copies per court rule)
□ 10. FEE:          Filing fee paid or fee waiver on file?
□ 11. PROPOSED ORDER: Required for motions? Attached?
□ 12. EXHIBITS:     All referenced exhibits attached? Properly indexed?
□ 13. PROOF:        Kept personal copy with timestamp/confirmation?
```
...
1. **Missing deadlines** — No excuse will save a missed jurisdictional deadline
2. **Failure to serve** — Filing without service = filing not effective
3. **Ex parte contact** — NEVER contact the judge directly outside of court
4. **Emotional filings** — Anger in writing undermines credibility permanently
5. **Over-filing** — Filing too many motions annoys courts; be strategic
6. **Ignoring orders** — Even wrong orders must be obeyed until reversed on appeal
7. **Waiving rights silently** — If you don't object on the record, you've waived it

### Court Clerk Interactions

**Clerks CAN:**
- Accept filings, provide forms, stamp copies
- Tell you filing fees and deadlines listed on court website
- Provide case register of actions
- Give you SCAO form numbers

**Clerks CANNOT:**
- Give legal advice (what to file, how to argue)
- Tell you whether your filing is "good enough"
- Recommend whether to appeal
- Interpret court orders for you

**Always be polite to clerks.** They control access to the system and can make your life easier or harder within their discretion.

### Multi-Court Navigation (Pigors-Specific)
*Source: litigation-pro-se-guardian*

Andrew Pigors may be simultaneously active in:

| Court | Case Type | Key Rules | Filing System |
|---|---|---|---|
| 14th Circuit (Muskegon) | Custody, Housing | MCR | MiFile |
| Michigan Court of Appeals | Appeal from 14th Circuit | MCR 7.2xx | MiFile |
| Michigan Supreme Court | Leave from COA | MCR 7.3xx | MiFile |
| W.D. Michigan (Federal) | § 1983 Civil Rights | FRCP, LCivR | CM/ECF (PACER) |

**Each court has separate:**
...
> service of process rules, proof of service, alternative service, MCR 2.105

### Michigan-Specific Rules
*Source: litigation-motion-practice*
...
*Source: litigation-service-engine*
...
> sanctions motions, contempt proceedings, fee petitions, enforcement

### Context: Pigors v Watson Sanctions Landscape
*Source: litigation-sanctions-engine*

### Lane A Sanctions Targets
- **Amy Watson:** Parenting time interference (contempt of custody order), frivolous claims
- **Gerald Rusco (GAL):** Biased investigation leading to frivolous recommendation
- **Tony Watson Sr.:** Interference with parental relationship, frivolous PP petition
- **Judge McNeill:** JTC complaint (separate track, not court sanctions per se)

### Lane B Sanctions Targets
- **Shady Oaks / Homes of America:** Discovery abuse, frivolous defenses to habitability claims, default for failure to respond
- **Alden Global Capital:** Corporate parent liability, discovery obstruction

### Lane C Convergence
- Pattern of sanctionable conduct across lanes strengthens each individual motion

### Master Sanctions Matrix
*Source: litigation-sanctions-engine*

| Sanction Type | Authority | Target Conduct | Remedy | Procedure |
|---------------|-----------|----------------|--------|-----------|
| Signing sanctions | MCR 2.114 | Frivolous pleading/motion/defense | Costs + fees + penalty | Motion + hearing |
| Discovery sanctions | MCR 2.313 | Discovery abuse/obstruction | Expenses → default | Motion + order → escalation |
| Default judgment | MCR 2.603 | Failure to plead/defend | Judgment for plaintiff | Application + proof |
| Civil contempt | MCR 3.606 | Violation of court order | Jail until compliance OR fine | Motion + hearing + due process |
| Criminal contempt | MCR 3.606 | Willful defiance of court | Jail (definite) + fine | Formal charges + beyond reasonable doubt |
| Frivolous action | MCL 600.2591 | Frivolous civil suit/defense | Costs + fees to prevailing party | Motion within 56 days of final order |
| Vexatious litigant | MCL 600.2591(4) | Pattern of frivolous filings | Bond requirement for future filings | Court's own motion or party motion |

### MCR 2.114 — Signing Sanctions (Frivolous Conduct)
*Source: litigation-sanctions-engine*

### What MCR 2.114 Requires
Every document filed must be signed by the party or attorney certifying that:
1. It is **well grounded in fact** (to the best of signer's knowledge after reasonable inquiry)
2. It is **warranted by existing law** or good-faith argument for extension/modification
3. It is **not interposed for improper purpose** (harassment, delay, needless increase in cost)

### Violation Triggers
- Filing claims/defenses with no factual basis
- Asserting legal positions contrary to well-established law
- Filing motions for purposes of delay or harassment
- Refusing to withdraw meritless positions after being informed

### Sanctions Available
- Reasonable expenses incurred because of the violation, including attorney fees
- Additional penalty to be paid to the court (up to $5,000 individual / $10,000 entity)
- Court may act on its own initiative or on motion

### Application to Pigors
- **Lane A:** If Amy Watson asserts factually baseless claims about Plaintiff's fitness
- **Lane A:** If Rusco's GAL report contains demonstrably false statements
- **Lane B:** If Shady Oaks raises defenses (habitability was maintained) contradicted by inspection records
...
|---------|---------------|-------------------|
| **Purpose** | Coerce compliance | Punish past conduct |
| **Jail** | Indefinite until compliance ("keys to the cell") | Definite term |
| **Fine** | Compensatory or coercive | Punitive |
| **Burden of proof** | Preponderance of evidence | Beyond reasonable doubt |
| **Right to jury** | No | If serious criminal contempt (>6 months) |
| **Purge condition** | Required—contemnor must be able to purge | Not applicable |
| **Due process** | Notice + hearing | Full criminal due process |

### Civil Contempt Elements
1. A clear and definite court order existed
2. The contemnor had knowledge of the order
3. The contemnor violated the order
4. The violation was willful (not excusable)
5. The contemnor has the present ability to comply

### Purge Condition Requirement
- Civil contempt must include a purge condition—something the contemnor CAN DO to be released
- If purge condition is impossible, the contempt becomes criminal (requires criminal due process)
- **Turner v. Rogers, 564 U.S. 431 (2011):** Due process requires ability-to-comply determination

### Application to Lane A
- **Amy Watson:** Contempt for violating parenting time order—document each denial with dates, communications, and witnesses
- **Purge condition:** Compliance with parenting time schedule + makeup time
- **Any party:** Contempt for violating discovery orders (after MCR 2.313 escalation)

### Sanctions Fee Petition Framework
*Source: litigation-sanctions-engine*

### Documentation Requirements
1. **Contemporaneous time records:** Log hours as you work, not after the fact
2. **Task descriptions:** Specific enough to evaluate reasonableness
3. **Hourly rate justification:** Local market rate for attorney with comparable experience
4. **Cost itemization:** Filing fees, copies, postage, mileage, parking

### Sample Fee Petition Structure

| Date | Task Description | Time (hrs) | Rate | Amount |
|------|-----------------|------------|------|--------|
| [Date] | Drafted meet-and-confer letter re: deficient interrogatory responses | 1.5 | $200 | $300 |
| [Date] | Researched MCR 2.313 sanctions standards | 2.0 | $200 | $400 |
| [Date] | Drafted motion to compel with exhibits | 3.0 | $200 | $600 |
| [Date] | Prepared for and attended hearing on motion | 2.5 | $200 | $500 |
| | **Attorney Fee Equivalent Subtotal** | **9.0** | | **$1,800** |
| | Filing fee | | | $50 |
| | Copies and postage | | | $35 |
| | Mileage (X miles @ IRS rate) | | | $XX |
| | **Total Costs** | | | **$XX** |
| | **GRAND TOTAL** | | | **$X,XXX** |

## §6. Analysis & Strategy

> case analysis, convergence orchestration, pipeline command, record building

### Case Lane Summary
*Source: litigation-os*
...
*Source: litigation-pipeline-commander*
...
> default judgment, summary judgment, FOC challenges, court order tracking

### Michigan Rules — Default Judgment
*Source: litigation-default-judgment-engine*
...
*Source: litigation-foc-challenge-engine*
...
> LitigationOS core, skill auditing, mandatory disclosure, filing workflow
...
*Source: litigation-lawsuit-forge*
...
| MCR 7.205 | 615 | 🆕 Verify & integrate |
