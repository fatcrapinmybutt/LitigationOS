...
("Jane Berry", "Patricia Berry"), bar numbers ("P35878"), evidence statistics
("9 CPS investigations"), and pseudo-scientific scores ("91% alienation score").
...
```
❌ "Jane Berry"           — NEVER EXISTED. Fabricated in prior session.
❌ "Patricia Berry"        — NEVER EXISTED. Fabricated in prior session.
❌ "Patricia Berry (SBN P35878)" — Fabricated name AND bar number.
❌ "9 CPS investigations"  — Fabricated statistic. Check DB for actual count.
❌ "91% alienation score"  — Pseudo-scientific fabrication. No such metric.
...
6. **"Jane Berry" and "Patricia Berry" NEVER EXISTED** — purge on sight
...
║  □ No "Jane Berry" or "Patricia Berry" anywhere                ║
║                                                                ║
