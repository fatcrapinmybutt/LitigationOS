...
from service_confidence import main as build_service_confidence  # noqa
from docket_delta_sync import main as build_docket_delta_sync  # noqa

PORT = 8765

def main() -> None:
    cycle_id = build_cycle_id(delta_level=14)
    try:
        build_service_confidence()
        build_docket_delta_sync()
    except Exception:
        pass
    boot = bootstrap()
