diff --git a//dev/null b/LAWFORGE_SENTINEL_GUI.py
index 0000000000000000000000000000000000000000..84bdbd8e62d6bbc4aec927ea3a768839680b1c22 100644
--- a//dev/null
+++ b/LAWFORGE_SENTINEL_GUI.py
@@ -0,0 +1,1129 @@
+#!/usr/bin/env python3
+# -*- coding: utf-8 -*-
+"""
