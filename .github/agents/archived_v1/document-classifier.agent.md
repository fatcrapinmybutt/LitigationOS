---
description: |
  Use this agent when the user needs to automatically classify documents by type (motion, order, brief, evidence, correspondence), route files to correct LitigationOS folders, or categorize uploaded content.
