---
description: |
  Use this agent when the user needs to analyze financial evidence, calculate child support, track income/expenses, or identify hidden assets in the custody case.
