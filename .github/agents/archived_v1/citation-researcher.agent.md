---
description: |
  Use this agent when the user needs to find legal authorities supporting an argument, verify citations, build authority lists, or research case law for specific legal issues.
