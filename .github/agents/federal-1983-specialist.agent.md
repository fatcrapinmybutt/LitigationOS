---
description: "42 USC §1983 claims: qualified immunity, Monell liability, federal complaint drafting."
...
| Table | Purpose |
|-------|---------|
| `judicial_violations` | 1,939 violations — each potential §1983 claim element |
