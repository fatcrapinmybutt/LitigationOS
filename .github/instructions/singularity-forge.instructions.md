...
## THEMANBEARPIG Skill Forge (25 Skills — 7 Tiers)

> **THEMANBEARPIG** is the 13-layer D3.js interactive litigation intelligence mega-visualization.
> 25 TRANSCENDENT-tier skills at `.agents/skills/SINGULARITY-MBP-*/SKILL.md` + `OMEGA-MBP-INDEX/SKILL.md`.
> Total: 18,220 lines, 625 KB. Commit `be390ddfe`.
...
| Ω OMEGA | 1 | 12 KB | Master manifest + activation matrix |
