...
| **Database** | litigation_context.db — 1.18GB, 85+ tables, 1.3M+ rows, 7 FTS5 indexes |
...
- **Defendant/Appellee:** Tiffany Watson (fka Pigors) — aka "Emily Watson" / "Emily A. Watson"
- **Judge:** Hon. Jenny L. McNeill
- **Child:** Lincoln (born ~2020, now ~6 years old)

**329+ days parent-child separation.** Last contact July 29, 2025. This fact must inform urgency in EVERY analysis and filing recommendation. Lincoln's developmental window is closing. Every day of delay is irreversible harm.
