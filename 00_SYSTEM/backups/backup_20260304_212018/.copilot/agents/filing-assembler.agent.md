---
description: "Use this agent when the user needs to compile court-ready filing packages, assemble exhibits with cover sheets and indices, generate proof of service, or build complete submission bundles for any court.
