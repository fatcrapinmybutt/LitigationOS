---
description: "Use this agent when the user needs to build case timelines, extract dates from documents, identify timeline gaps, or create chronological narratives for filings.
