---
description: "Use this agent when the user needs to build witness profiles, assess credibility, track prior statements, or prepare witness examination outlines.
...
- `contradiction_map` — 10,672 contradictions by party
