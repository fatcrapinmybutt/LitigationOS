---
description: "Use this agent when the user needs to prepare for depositions, build question outlines, identify impeachment traps, or plan deposition strategy.
...
Examples:
- User says 'prepare deposition outline for Emily Watson' → invoke this agent to build topic-by-topic question outline with impeachment documents
- User says 'what exhibits do I need for the FOC deposition' → invoke this agent to select key exhibits for deposition confrontation"
