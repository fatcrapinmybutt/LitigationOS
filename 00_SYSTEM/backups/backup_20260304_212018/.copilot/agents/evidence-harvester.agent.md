---
description: "Use this agent when the user needs to find, extract, link, or validate evidence from the 7.4GB litigation database, 308K+ evidence quotes, 26,409 extracted harms, or scan inventories.
...
| Table | Rows | Purpose |
|-------|------|---------|
| `evidence_quotes` | 308K+ | Direct quotes from PDFs, court docs, ChatGPT refs (has `source_type` column) |
...
| `contradiction_map` | 10,672 | Contradictions between sources |
